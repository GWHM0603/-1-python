# ===========================================================
# 메소드 오버라이딩
# 부모 클래스의 메소드를 자식클래스에서 자식클래스에 맞게 수정하여 사용하는 방법
# ============================================================
...
##             점 그리기 기능  --- drawing()
##             점 변경 기능   ---- converting() 
##             -> 자식클래스에만 있는 함수는 부모클래스에서 상속받아서 사용못하고, 직접 구현해야함
## 부모클래스: Point
## ----------------------------------------------------------
class Point3D (Point):
    # -----------------------
...
print("-"*10)
p2.print_info() # Point에서 상속받은 메소드
p2.drawing() # Piont에서 상속받은 메소드
p2.conberting("별") #  Point3D 자체 메소드
